    ...
    <div className="min-h-screen bg-background pt-32 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-foreground mt-10 mb-4">ข้อจำกัดความรับผิดชอบ (Disclaimer)</h2>
          <p className="text-lg text-foreground font-bold bg-rose-50 dark:bg-rose-950/30 p-4 rounded-lg border border-rose-200 dark:border-rose-900">
            ระบบนี้ไม่ใช่เครื่องมือทางการแพทย์และไม่ได้ใช้เพื่อการรักษา (Not a Medical Device)
          </p>
          <p>การประมวลผลข้อมูลสุขภาพของระบบเป็นเพียง <strong className="text-foreground">การแสดงข้อมูลประกอบการดูแลเบื้องต้น</strong> ไม่ใช่คำวินิจฉัย หรือคำสั่งแทนผู้เชี่ยวชาญ การตัดสินใจที่สำคัญควรได้รับคำปรึกษาจากผู้เชี่ยวชาญเท่านั้น</p>
