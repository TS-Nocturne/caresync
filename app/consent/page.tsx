    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4 relative">
      <div className="max-w-2xl w-full bg-card rounded-2xl shadow-xl border border-border p-8 flex flex-col max-h-[90vh]">
        ...
        <div className="flex-1 overflow-y-auto pr-4 space-y-4 text-sm text-muted-foreground bg-muted/30 p-6 rounded-lg border border-border">
          <p>
            ยินดีต้อนรับสู่ CareSync แพลตฟอร์มการดูแลผู้สูงอายุ กรุณาอ่านและทำความเข้าใจข้อกำหนดการใช้งานดังต่อไปนี้ก่อนเข้าสู่ระบบ
          </p>
          <h3 className="font-semibold text-foreground pt-2">1. การเก็บรักษาข้อมูลส่วนบุคคล</h3>
          <p>
            เราให้ความสำคัญกับความเป็นส่วนตัวของข้อมูลผู้สูงอายุและผู้ดูแล ระบบจะเก็บรักษาข้อมูลอย่างปลอดภัยตามมาตรฐาน และจะไม่นำข้อมูลไปเปิดเผยให้บุคคลที่สามโดยไม่ได้รับอนุญาต
          </p>
          <h3 className="font-semibold text-foreground pt-2">2. การให้สิทธิ์การเข้าถึงข้อมูล</h3>
          <p>
            การมอบสิทธิ์ให้บุคคลในครอบครัวหรือผู้ดูแล ถือเป็นความรับผิดชอบของผู้ดูแลหลัก (Owner) ระบบจะไม่รับผิดชอบต่อความเสียหายที่เกิดจากการให้สิทธิ์ผิดพลาด
          </p>
          <h3 className="font-semibold text-foreground pt-2">3. ข้อมูลประกอบการดูแล (Care Coordination)</h3>
          <p>
            ข้อมูลที่ระบบสรุปเป็นเพียงบันทึกประกอบการดูแลและการประสานงาน ไม่ใช่คำวินิจฉัย หรือคำสั่งแทนผู้เชี่ยวชาญ หากสงสัยเหตุเร่งด่วนให้ติดต่อบริการช่วยเหลือโดยตรง
          </p>
          <h3 className="font-semibold text-foreground pt-2">4. ระยะเวลาการเก็บรักษาข้อมูล (Data Retention)</h3>
          <p>
            ในกรณีที่คุณขาดการต่ออายุแพ็กเกจ (Subscription Expired) ระบบจะเข้าสู่โหมดดูข้อมูลย้อนหลัง (Read-Only) และจะเก็บรักษาประวัติข้อมูลของผู้สูงอายุไว้ให้ดูย้อนหลังเป็นเวลา 1 ปี หลังจากนั้นระบบจะทำการลบข้อมูลโดยอัตโนมัติเพื่อความเป็นส่วนตัวและสอดคล้องกับนโยบาย PDPA (Zero Data Retention)
          </p>
